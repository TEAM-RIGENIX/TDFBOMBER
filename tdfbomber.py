...
description = """TDFBomber - Your Friendly Spammer Application

TDFBomber can be used for many purposes which incudes -
...
TDFBomber is not intented for malicious uses.
